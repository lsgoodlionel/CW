...
_RULES: list[tuple[str, str, str, str]] = [
    ...
    (r"POST", r"^/api/auth-presets$", "user", "新增授权预设"),
    (r"PUT", r"^/api/auth-presets/(\d+)$", "user", "修改授权预设 #{id}"),
    (r"DELETE", r"^/api/auth-presets/(\d+)$", "user", "删除授权预设 #{id}"),
    (r"POST", r"^/api/auth-presets/apply$", "user", "批量应用授权预设"),
